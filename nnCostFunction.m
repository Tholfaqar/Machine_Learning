...
% creating y for the neural net: y1 size (m x num_labels)
y1 = zeros(size(y), num_labels);  % or size 5000 x 10
for i=1:size(y1, 1)
  val = y(i);
  y1(i,val) = 1;
end
...
% doing backpropagation and calculating the grads

%1.
% a3 is calculated in line 75 above
